...
<div class="wrapper fadeInDown">
  ...
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form action="sign/sign-in.php" method="POST">
      <svg  width="100" height="100" fill="currentColor" class="bi bi-wordpress" viewBox="0 0 16 16">
  ...
  <path fill-rule="evenodd" d="M0 8c0-4.411 3.589-8 8-8 4.41 0 8 3.589 8 8s-3.59 8-8 8c-4.411 0-8-3.589-8-8zm.367 0c0 4.209 3.424 7.633 7.633 7.633 4.208 0 7.632-3.424 7.632-7.633C15.632 3.79 12.208.367 8 .367 3.79.367.367 3.79.367 8z"/>
      ...
      <input type="text" id="login" class="fadeIn second" name="uname" placeholder="login" required>
      <input type="text" id="password" class="fadeIn third" name="pwd" placeholder="password" required>
